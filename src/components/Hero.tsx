...
function PhotoCard() {
  return (
    <RevealCard
      className="col-span-1 row-span-2 md:col-span-4 lg:col-span-2 card-photo relative overflow-hidden rounded-[20px] md:aspect-auto"
      delay={0.05}
    >
      <motion.img
        src="/nakhshab.jpg"
...
function QuoteCard() {
  return (
    <RevealCard
      className="col-span-1 md:col-span-6 lg:col-span-3 card-role-quote rounded-[20px] flex items-center"
      style={{
        background: "#0b0a1a",
      }}
      delay={0.1}
